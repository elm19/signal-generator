...
response = requests.get('http://your-pythonanywhere-username.pythonanywhere.com/model-info')
print(response.json())
```
...
model_name = "lstm"
response = requests.get(f'http://your-pythonanywhere-username.pythonanywhere.com/model-info/{model_name}')
print(response.json())
```
